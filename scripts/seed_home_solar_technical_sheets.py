...
FICHAS = {
    ...
    224: ("inversor", {"tipo_inversor": "Off-grid", "potencia_nominal_w": 1000, "voltaje_banco_bateria_v": 12}),
    225: ("inversor", {"tipo_inversor": "Off-grid", "potencia_nominal_w": 1500, "voltaje_banco_bateria_v": 24}),
    226: ("inversor", {"tipo_inversor": "Off-grid", "potencia_nominal_w": 2000, "voltaje_banco_bateria_v": 24}),
    227: ("inversor", {"tipo_inversor": "Off-grid", "potencia_nominal_w": 3000, "voltaje_ac_salida_v": 120, "corriente_max_fv_a": 80}),
    228: ("inversor", {"tipo_inversor": "Off-grid", "potencia_nominal_w": 3000, "voltaje_banco_bateria_v": 24}),
    229: ("inversor", {"tipo_inversor": "Off-grid", "potencia_nominal_w": 6000, "voltaje_banco_bateria_v": 48, "fases": "Split phase"}),
    230: ("inversor", {"tipo_inversor": "Off-grid", "potencia_nominal_w": 8000, "voltaje_banco_bateria_v": 48, "fases": "Split phase"}),
    231: ("inversor", {"tipo_inversor": "Off-grid", "potencia_nominal_w": 12000, "voltaje_banco_bateria_v": 48, "fases": "Split phase"}),
    232: ("inversor", {"tipo_inversor": "Off-grid", "potencia_nominal_w": 12000, "voltaje_banco_bateria_v": 48, "corriente_max_fv_a": 200}),
