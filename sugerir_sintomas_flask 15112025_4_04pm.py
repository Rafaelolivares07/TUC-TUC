...
✅ SUGERIR SÍNTOMAS - VERSIÓN ACTIVA
   ...
   Cambios:
   • Template única (sin cambio de página)
   • Auto-procesado al pegar (sin botón manual)
   • Alerta oculta cuando hay texto
   • ✅ Arreglado: Verifica si síntoma existe antes de insertar
   • ✅ Diagnósticos existentes ahora habilitados
   • ✅ Soporte para anticonceptivos y medicamentos preventivos
   • ✅ Cobertura completa de productos de farmacia (90+ categorías)
   • ✅ NUEVO: Detección flexible de plurales
       - 'hormona' detecta 'hormona' o 'hormonas'
       - 'dolor' detecta 'dolor' o 'dolores'
       - 'infección' detecta 'infección' o 'infecciones'
   • ✅ Saltear scraping chequeado por defecto
   • Flujo: Seleccionar → Pegar → Procesa automático → Guardar
{'='*70}
""")
app = Flask(__name__)
