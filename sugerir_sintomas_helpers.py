...
REGLAS_DIAGNOSTICOS = {
    ...
    # ========== BELLEZA Y COSMÉTICA AVANZADA ==========
    'anti-edad': ['arrugas', 'líneas de expresión', 'envejecimiento prematuro', 'flacidez', 'pérdida de firmeza'],
    'antiarrugas': ['arrugas', 'líneas de expresión', 'patas de gallo', 'líneas finas'],
    'firmeza': ['piel flácida', 'pérdida de elasticidad', 'falta de firmeza', 'piel colgante'],
    'elasticidad': ['pérdida de elasticidad', 'piel flácida', 'falta de tonicidad'],
    'rejuvenecimiento': ['envejecimiento de piel', 'piel madura', 'signos de edad'],
    'tonificar': ['piel flácida', 'falta de tono', 'pérdida de firmeza'],
    'exfoliación': ['células muertas', 'piel opaca', 'textura irregular', 'poros obstruidos'],
    'renovación celular': ['piel opaca', 'células muertas', 'textura irregular'],
    'aclarar piel': ['manchas oscuras', 'hiperpigmentación', 'tono irregular', 'melasma'],
    'unificar tono': ['tono irregular', 'manchas', 'decoloración', 'pigmentación desigual'],
    'radiancia': ['piel opaca', 'falta de brillo', 'tono apagado'],
    'nutrición de piel': ['piel seca', 'falta de nutrientes', 'piel maltratada'],
    'reparación de piel': ['piel dañada', 'daño solar', 'cicatrices', 'piel maltratada'],
    'piel sensible': ['irritación', 'enrojecimiento', 'sensibilidad', 'intolerancia'],
    'calmar piel': ['irritación', 'enrojecimiento', 'inflamación', 'sensibilidad'],
    'antiinflamatorio cosmético': ['enrojecimiento', 'irritación', 'inflamación de piel'],
    'despigmentante': ['manchas oscuras', 'hiperpigmentación', 'melasma', 'pecas'],
    'acné cosmético': ['granos', 'espinillas', 'puntos negros', 'brotes', 'comedones'],
    'poros dilatados': ['poros abiertos', 'poros visibles', 'textura irregular'],
    'brillo facial': ['piel grasa', 'exceso de sebo', 'zona t brillante'],
    'matificante': ['brillo excesivo', 'piel grasa', 'exceso de sebo'],
    'equilibrio de ph': ['piel sensible', 'irritación', 'desequilibrio cutáneo'],
    'protección solar': ['daño solar', 'rayos uv', 'quemaduras solares', 'fotoenvejecimiento'],
    'after sun': ['quemaduras solares', 'piel quemada', 'enrojecimiento post-solar'],

    # ========== CUIDADO CORPORAL ==========
    'hidratación corporal': ['piel seca en cuerpo', 'resequedad corporal', 'descamación en cuerpo'],
    'cuidado de manos': ['manos secas', 'manos agrietadas', 'resequedad en manos'],
    'cuidado de pies': ['pies secos', 'talones agrietados', 'callos', 'durezas'],
    'suavidad corporal': ['piel áspera en cuerpo', 'textura rugosa'],
    'estrías': ['marcas de estiramiento', 'estrías rojas', 'estrías blancas'],
    'celulitis': ['piel de naranja', 'nódulos de grasa', 'textura irregular en muslos'],
    'reafirmante corporal': ['flacidez corporal', 'pérdida de firmeza en cuerpo'],
    'desodorante': ['olor corporal', 'sudoración', 'mal olor axilar'],
    'antitranspirante': ['sudoración excesiva', 'hiperhidrosis', 'exceso de sudor'],

    # ========== CUIDADO CAPILAR ==========
    'cabello seco': ['resequedad capilar', 'cabello áspero', 'falta de hidratación capilar'],
    'cabello graso': ['exceso de grasa capilar', 'cuero cabelludo graso', 'cabello oleoso'],
    'caída de cabello': ['pérdida de cabello', 'alopecia', 'debilitamiento capilar'],
    'caspa': ['descamación del cuero cabelludo', 'escamas', 'picazón en cuero cabelludo'],
    ...
    'nutrición capilar': ['cabello maltratado', 'cabello dañado', 'falta de nutrientes'],
